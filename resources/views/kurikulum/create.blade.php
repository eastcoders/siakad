...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Perkuliahan / Kurikulum /</span> Tambah Data
    </h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.kurikulum.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label" for="nama_kurikulum">Nama Kurikulum <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('nama_kurikulum') is-invalid @enderror" 
                            id="nama_kurikulum" name="nama_kurikulum" value="{{ old('nama_kurikulum') }}" required placeholder="Contoh: Kurikulum 2024">
                        @error('nama_kurikulum')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="jumlah_sks_pilihan">Jumlah Bobot Mata Kuliah Pilihan <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="number" class="form-control sks-input @error('jumlah_sks_pilihan') is-invalid @enderror" 
                                id="jumlah_sks_pilihan" name="jumlah_sks_pilihan" value="{{ old('jumlah_sks_pilihan', 0) }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control bg-light" 
                                id="jumlah_sks_lulus" name="jumlah_sks_lulus" value="{{ old('jumlah_sks_lulus', 0) }}" readonly>
                            <span class="input-group-text text-muted">( sks Wajib + sks Pilihan )</span>
                        </div>
                        <small class="text-muted">Otomatis terhitung.</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="jumlah_sks_wajib">Jumlah Bobot Mata Kuliah Wajib <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="number" class="form-control sks-input @error('jumlah_sks_wajib') is-invalid @enderror" 
                                id="jumlah_sks_wajib" name="jumlah_sks_wajib" value="{{ old('jumlah_sks_wajib', 0) }}" min="0" required>
                            <span class="input-group-text">sks</span>
