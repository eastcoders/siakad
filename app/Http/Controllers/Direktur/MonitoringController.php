...
class MonitoringController extends Controller
{
    ...
    {
        Log::info("VIEW_MONITORING: Direktur mengakses dashboard monitoring perkuliahan");
        ...
        return view('direktur.monitoring.index', compact(
            'kelasKuliahs',
            'semesters',
            'semesterId',
            'stats',
    ...
    {
        Log::info("VIEW_MONITORING: Direktur melihat detail kelas", ['id' => $id]);
        ...
        return view('direktur.monitoring.show', compact('kelas', 'jurnal', 'rekapAbsensi'));
    }
}
